      ...
      <main className="ml-20 pt-20 p-8">
        <div className="max-w-[1600px] mx-auto">
          <div className="mb-8">
            ...
            <p className="text-zinc-500 mt-1">Schedule and manage your team collaboration sessions</p>
          </div>
          ...
          <div className="bg-[#121212] rounded-[32px] border border-white/5 p-8 shadow-xl">
            ...
            <p className="text-zinc-500">Meeting scheduling features are being enhanced to match the new design...</p>
          </div>
        </div>
      </main>
    </div>
